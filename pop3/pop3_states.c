...
unsigned on_read_ready_auth(struct selector_key *key){ return 0; }
unsigned on_write_ready_auth(struct selector_key *key){ return 0; }
unsigned on_block_ready_auth(struct selector_key *key){ return 0; }
...
unsigned on_write_ready_trans(struct selector_key *key){ return 0; }
unsigned on_block_ready_trans(struct selector_key *key){ return 0; }
...
unsigned on_read_ready_update(struct selector_key *key){ return 0; }
unsigned on_write_ready_update(struct selector_key *key){ return 0; }
unsigned on_block_ready_update(struct selector_key *key){ return 0; }
...
unsigned on_read_ready_error(struct selector_key *key){ return 0; }
unsigned on_write_ready_error(struct selector_key *key){ return 0; }
unsigned on_block_ready_error(struct selector_key *key){ return 0; }
