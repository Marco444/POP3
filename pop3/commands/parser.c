...
static void consume_space(struct parser_event *ret, const uint8_t c, struct commands_state * ctx, enum pop3_states pop3_state, enum pop3_states * next_state,bool * read_action ){}

static void consume_into_cmd(struct parser_event *ret, const uint8_t c, struct commands_state * ctx, enum pop3_states pop3_state, enum pop3_states * next_state,bool * read_action ) {
...
static void consume_into_arg1(struct parser_event *ret, const uint8_t c, struct commands_state * ctx, enum pop3_states pop3_state, enum pop3_states * next_state,bool * read_action ) {
...
static void consume_into_arg2(struct parser_event *ret, const uint8_t c, struct commands_state * ctx, enum pop3_states pop3_state, enum pop3_states * next_state,bool * read_action ) {
    // append the character to the first argument
...
static void process_command_handler(struct parser_event *ret, const uint8_t c, struct commands_state * ctx, enum pop3_states pop3_state, enum pop3_states * next_state,bool * read_action ) {
...
static void invalid_arguments(struct parser_event *ret, const uint8_t c, struct commands_state * ctx, enum pop3_states pop3_state, enum pop3_states * next_state,bool * read_action ) {
