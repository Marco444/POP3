...
MAIN_SOURCES=$(wildcard *.c pop3/*.c pop3/commands/*.c  pop3/commands/authorization/*.c  pop3/commands/update/*.c  pop3/commands/transaction/*.c pop3/states/*.c pop3/new_connection/*.c  )
