...
MAIN_SOURCES=$(wildcard *.c pop3/*.c pop3/commands/*.c pop3/commands/monitor/authorization/*.c   pop3/commands/server/authorization/*.c  pop3/commands/server/update/*.c  pop3/commands/server/transaction/*.c pop3/states/*.c pop3/monitor-states/*.c pop3/new_connection/*.c  )
