...
struct parser_state_transition {
    ...
    void    (*act1)(struct parser_event *ret, const uint8_t c, struct commands_state * ctx, enum pop3_states pop3_state);
    /** otra acción opcional */
    void    (*act2)(struct parser_event *ret, const uint8_t c, struct commands_state * ctx, enum pop3_states pop3_state);
};
...
parser_feed     (struct parser *p, const uint8_t c, struct commands_state * ctx, enum pop3_states pop3_state);
